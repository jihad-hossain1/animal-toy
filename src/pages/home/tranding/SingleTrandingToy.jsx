            ...
            {/* {quantity <= 0 ? 'hidden' :'block' } */}
                ...
                <img src={images?.img.img1} alt="" />
                    ...
                    <div className="absolute w-full h-full flex flex-col justify-between -bottom-10 bg-blue-gray-400 bg-opacity-10 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                        ...
                        <button onClick={()=>handleEnrollCart(ite)} disabled={quantity == 0 } className='bg-[#f0c507] px-2 py-1 md:px-4 md:py-2 rounded text-black text-xs md:text-[14px] inline-block uppercase hover:bg-[#fc82bd] hover:text-white transition-all duration-500'>add to cart</button>
                        </div>
                    </div>
